# Source https://github.com/osmhpi/learning-tangle/blob/master/leaf/models/femnist/cnn.py
...
class ClientModel(Model):
    def __init__(self, seed):
        lr, self.num_classes = MODEL_PARAMS['femnist.cnn']
    ...
    def create_model(self):
        ...
        train_op = self._get_optimizer.minimize(
            loss=loss,
