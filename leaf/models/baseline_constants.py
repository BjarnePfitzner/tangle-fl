...
MODEL_PARAMS = {
    ...
    'femnist.cnn': (0.0003, 2), # lr, num_classes
    'femnist_clustered.cnn': (0.0003, 2), # lr, num_classes
    'femnist_clustered_alt.cnn': (0.0003, 2), # lr, num_classes
