...
DATASETS = ['sent140', 'femnist', 'shakespeare', 'celeba', 'synthetic', 'reddit', 'femnist_clustered', 'femnist_clustered_alt']
...
def parse_args():
    ...
    parser.add_argument('--tangle-dir',
                    help='folder to store tangle_data to',
                    type=str,
                    default='.')

    # Parameters for TipSelectors

    parser.add_argument('-ts','--tip-selector-from',
                    action='append',
                    help='Add a new start round from where to use TipSelectors. Default: [0]',
                    required=False,
                    default=[])

    parser.add_argument('-ats', '--acc-tip-selector-from',
                    action='append',
                    help='Add a new start round from where to use AccuracyTipSelectors',
                    required=False,
                    default=[])

    parser.add_argument('-mts', '--mal-tip-selector-from',
                    action='append',
                    help='Add a new start round from where to use MaliciousTipSelectors',
                    required=False,
                    default=[])
