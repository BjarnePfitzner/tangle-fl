class Progress:
    ...
    def eta(self, epoch_num):
        # epoch_num starts at 0, therefore we add 1 here
        actual_epoch_num = epoch_num + 1
        remaining_number_evals = (self.total_rounds - actual_epoch_num) // self.rounds_per_eval + 1
        number_evals_so_far = actual_epoch_num // self.rounds_per_eval
        ...
        remaining_train_duration = self._total_train_duration / actual_epoch_num * (self.total_rounds - actual_epoch_num)
