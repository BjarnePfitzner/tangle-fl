...
class FeatureSelector:
    ...
    def identify_collinear(self, data, correlation_threshold):
        ...
        logging.info('%d features with a correlation greater than %0.2f.\n' % (
    ...
    def identify_low_importance(self, cumulative_importance):
        ...
        logging.info('%d features that do not contribute to cumulative importance of %0.2f.\n' % (
    ...
    def identify_all(self, features, labels, selection_params):
        ...
        logging.info('%d total features out of %d identified for removal.\n' % (
    ...
    def check_identified(self):
        ...
        logging.info(all_identified)
        logging.info('%d features identified for removal' % len(all_identified))
    ...
    def remove(self, data, methods, one_hot=True):
        ...
        if methods == 'all':
            ...
            logging.info('{} methods have been run'.format(list(self.removal_ops.keys())))
        ...
        logging.info(f'Removed {len(features_to_drop)} features ({features_to_drop})')
        return data
